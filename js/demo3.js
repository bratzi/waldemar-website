            ...
            this.DOM.svg.innerHTML = `
                ...
                <linearGradient id="gradient1" x1="0%" y1="0%" x2="0%" y2="100%">
                    <stop offset="0%" stop-color="#22e1ff">
                        <!--animate attributeName="stop-color" values="#22e1ff; #625eb1; #22e1ff" dur="3s" repeatCount="indefinite"></animate-->
                    </stop>
                    <stop offset="100%" stop-color="#625eb1">
                        <!--animate attributeName="stop-color" values="#625eb1; #22e1ff; #625eb1" dur="3s" repeatCount="indefinite"></animate-->
                    </stop>
                </linearGradient>
                </defs>
                ...
                animateShapeOutTimeline
                    ...
                    .add({
                        ...
                        complete: () => {
                            ...
                            $("div.slide--current").css("transform", "none");
                        }
                    });
            }
